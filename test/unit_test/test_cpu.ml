...
let%expect_test "CALL 0x0042" =
    ...
    [%expect
        {| 
        SP:0xe PC:0x42 REG:A: 0x0 B: 0x0 C: 0x0 D: 0x0 E: 0x0 F: 0x0 H: 0x0 L: 0x0 
        6
        |}]
...
let%expect_test "JR None" =
    ...
    [%expect
        {| 
        SP:0x0 PC:0x44 REG:A: 0x0 B: 0x0 C: 0x0 D: 0x0 E: 0x0 F: 0x0 H: 0x0 L: 0x0 
        3
        |}]
...
let%expect_test "JR Z" =
    ...
    [%expect
        {| 
        SP:0x0 PC:0x45 REG:A: 0x0 B: 0x0 C: 0x0 D: 0x0 E: 0x0 F: 0x80 H: 0x0 L: 0x0 
        3
        |}]
